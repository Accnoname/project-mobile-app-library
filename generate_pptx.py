...
add_slide(
    ...
    [
        ...
        "Đóng góp của nhóm:",
        "- SV 1 (Nhóm trưởng): Setup Firebase, Code Dashboard UI, viết Unit Test.",
        "- SV 2 (Thành viên 2): Code màn hình Sách, Mượn/Trả...",
        "- SV 3 (Thành viên 3): Viết báo cáo, vẽ sơ đồ UML, thiết kế Slide."
    ]
)
