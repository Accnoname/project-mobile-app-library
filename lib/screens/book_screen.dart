...
class _BookCard extends StatelessWidget {
  ...
  const _BookCard({required this.book, required this.isDark, required this.onTap});
              ...
              child: book.imageUrl.isNotEmpty
                  ? Image.network(
                      ...
                      loadingBuilder: (_, child, progress) => progress == null
                          ? child
                          : SizedBox(width: imgW, height: imgH,
  ...
  Widget _placeholder(double w, double h, bool isDark) {
    return Container(
      ...
      child: Icon(Icons.menu_book_rounded,
          color: isDark ? const Color(0xFF495057) : const Color(0xFFCED4DA), size: 28),
    );
  }
}
